...
\graffito{\gls{LibCloud} permite generar una capa de abstracción a partir de una \acrshort{API} unificada usando controladores para cada tipo de servicio que prestan muchos de los \acrshortpl{CCSP}.\bigskip}
